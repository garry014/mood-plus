...
INSERT INTO `moodplusdb`.`posts` (`id`, `post`, `username`, `usertype`, `timestamp`, `hiddenReason`, `threadId`) VALUES ('103', '<p>3 wonderful kids , heart broken for them</p>', 'customer2', 'customer', '13 February 2023 10:20 PM', '', '100');
